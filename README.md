[app.js](https://github.com/user-attachments/files/29160751/app.js)[index.html](https://github.com/user-attachments/files/29160743/index.html)
[Uploading app.js…](// 1. 문제 데이터셋 정의 (원본 파이썬 코드와 동일)
